...
import { visibleSettingsTabs } from "@/lib/settings/isSettingsAdminUser";
...
export default function SettingsMain() {
  ...
  }, [activeTab, setSearchParams, tabParam, tabs]);
  ...
  return (
    <div
      ...
      className={cn("mx-auto w-full max-w-5xl px-4 pb-8 pt-24 md:px-8")}
    >
      <div className="flex w-full flex-col gap-6">
        <header className="flex flex-col gap-2">
          <h1 className={bubbleStyle("Text_heading_1_")}>Account Settings</h1>
