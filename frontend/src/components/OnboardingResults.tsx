  ...
  return (
    <div className="flex flex-1 items-start justify-center px-4 py-10 overflow-y-auto">
      <div className="max-w-2xl w-full space-y-8 pb-12">
        {/* Step indicator */}
        <p className="text-sm font-medium text-muted-foreground tracking-wide uppercase text-center">
          Step 12 of 12
        </p>

        {/* Headline */}
        <h1 className="text-3xl md:text-4xl font-bold text-foreground leading-tight tracking-tight text-center">
        ...
        {(results.recovery_mode_active || results.grief_mode_active) && (
          <div className="flex flex-wrap gap-2 justify-center">
            {results.recovery_mode_active && (
              <Badge className="bg-emerald-600 hover:bg-emerald-600 text-white px-4 py-1.5 text-sm font-medium gap-1.5">
