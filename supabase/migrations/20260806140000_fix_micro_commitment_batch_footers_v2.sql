-- v2: previous fix required end-of-string immediately after the marker
-- (BATCH … COMPLETE), so footers with trailing manifest text were not stripped.
