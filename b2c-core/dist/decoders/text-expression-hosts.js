...
exports.resolveTextExpressionHostClass = resolveTextExpressionHostClass;
var RENDER_PROP_HOST_KEYS = new Set([
    "text",
    "placeholder",
    "default_value",
    "initial_content",
...
var FORMATTING_UTILITY_HOST_KEYS = new Set([
    "content",
    "arbitrary_text",
    "unique_id",
...
var WORKFLOW_API_SUBSTITUTION_PREFIXES = [
    "body_params_",
    "url_params_",
    "params_",
    "headers_",
...
function isElementDefinitionOpaqueHost(pointer) {
...
function resolveTextExpressionHostClass(pointer, hostKey) {
    ...
    if (WORKFLOW_API_SUBSTITUTION_PREFIXES.some(function (prefix) { return hostKey.startsWith(prefix); })) {
